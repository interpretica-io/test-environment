...
/** @file
 * @brief TA WiFi helpers
 *
 * @defgroup ta_wifi_helpers Publicly available WiFi agent library functions and helpers.
 * @ingroup ta_wifi
 * @{
 *
 * Helpers
 ...
 */
static inline const char *ta_wifi_configurator_from_value(ta_wifi_configurator value)
{
 ...
 */
static inline ta_wifi_mode ta_wifi_configurator_from_str(const char *str)
{
 ...
 * @return The pointer to the string representation
 */
static inline const char *ta_wifi_standard_from_value(ta_wifi_standard value)
{
 ...
 */
static inline ta_wifi_standard ta_wifi_standard_from_str(const char *str)
{
 ...
 * @return The pointer to the string representation
 */
static inline const char *ta_wifi_width_from_value(ta_wifi_width value)
{
 ...
 */
static inline ta_wifi_standard ta_wifi_width_from_str(const char *str)
{
 ...
 * @return The pointer to the string representation
 */
static inline const char *ta_wifi_mode_from_value(ta_wifi_mode value)
{
 ...
 */
static inline ta_wifi_mode ta_wifi_mode_from_str(const char *str)
{
 ...
 * @return The pointer to the string representation
 */
static inline const char *ta_wifi_security_from_value(ta_wifi_security value)
{
 ...
 */
static inline ta_wifi_security ta_wifi_security_from_str(const char *str)
{
 ...
 * @return The pointer to the string representation
 */
static inline const char *ta_wifi_protocol_from_value(ta_wifi_protocol value)
{
 ...
 */
static inline ta_wifi_mode ta_wifi_protocol_from_str(const char *str)
{
